...
import 'package:lookbook/pfpClass.dart';
import 'package:lookbook/screens/common_widgets.dart';
import 'package:rxdart/rxdart.dart';

import '../../../Preferences/LoginData.dart';
import '../../../Services/profiles.dart';
import '../../../concatFunction.dart';
...
class ListingAndProfiles {
  ...
  ListingAndProfiles({required this.brandProfiles, required this.jobModels});
}
  ...
  Stream<ListingAndProfiles> fetchAllData() {
    ...
    return Rx.combineLatest2(
      ...
      jobListingsStream,
        ...
        return ListingAndProfiles(brandProfiles: brandProfiles, jobModels: jobModels);
      },
    );
  }
